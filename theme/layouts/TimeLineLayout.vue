...
export default {
    ...
    mounted() {
        ...
        this.$scrollReveal(`.${this.$style.date}`, { reset: false, interval: 66 });
        this.$scrollReveal(`.${this.$style.title}`, { reset: false, delay: 66, origin: 'right', distance: '100px', interval: 66 });
    },
};
</script>
